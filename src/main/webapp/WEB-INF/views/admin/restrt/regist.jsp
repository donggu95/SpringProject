            ...
            <div class="card card-info">
              ...
              <form name="form1" enctype="multipart/form-data">
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="맛집명 입력.." name="restrt_NM">
                  </div>
                  
                  <div class="form-group">
                    <input type="text" class="form-control" placeholder="대표음식명" name="restrt_re">
                  </div>
                  
                  <div class="form-group">
                    <textarea id="introduce" placeholder="맛집소개" name="introduce">상품 간략 소개</textarea>
                  </div>
                  
                  <div class="form-group">
                    <textarea id="detail" name="detail">맛집 상세 정보</textarea>
                  </div>
